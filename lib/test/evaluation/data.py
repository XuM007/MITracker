...
class Sequence:
    ...
    def __init__(self, name, frames, dataset, ground_truth_rect, ground_truth_seg=None, init_data=None,
                 ...
                 text_description=None, scene_name=None, seq_view_id=None):
        self.name = name
        self.frames = frames
    ...
    def object_init_data(self, frame_num=None) -> dict:
        ...
        if self.scene_name is not None:
            init_data['scene_name'] = self.scene_name
        
        if self.seq_view_id is not None:
            init_data['seq_view_id'] = self.seq_view_id
