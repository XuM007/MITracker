...
class EnvSettings_ITP:
    def __init__(self, workspace_dir, data_dir, save_dir):
        ...
        self.results_path = os.path.join(save_dir, 'tracking_results')
        self.segmentation_path = os.path.join(save_dir, 'segmentation_results')
        # self.network_path = os.path.join(save_dir, 'networks')
        self.result_plot_path = os.path.join(save_dir, 'result_plots')
        self.got10k_path = os.path.join(data_dir, 'got10k')
        self.mvtrack_dir = os.path.join(data_dir, 'MVTrack')
        self.gmtd_dir = os.path.join(data_dir, 'GMTD')
