...
dataset_dict = dict(
    ...
    mvtrack_sot_test=DatasetInfo(module=pt % "mvtrack", class_name="MVTrackSotDataset", kwargs=dict(split='test')),
    mvtrack_mot_test=DatasetInfo(module=pt % "mvtrack", class_name="MVTrackMotDataset", kwargs=dict(split='test')),
    gmtd_sot=DatasetInfo(module=pt % "gmtd", class_name="GMTDSotDataset", kwargs=dict()),
    gmtd_mot=DatasetInfo(module=pt % "gmtd", class_name="GMTDMotDataset", kwargs=dict()),
)
