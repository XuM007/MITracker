...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, help='Name of the training script') 
    parser.add_argument('--config', type=str, default='baseline', help='Name of the YAML configuration file') 
    ...
    parser.add_argument('--mode', type=str, choices=["single", "multiple", "multi_node"], default="multiple",
                        help="Training mode: single GPU, multiple GPUs, or multiple nodes") 
    parser.add_argument('--nproc_per_node', type=int, help="Number of GPUs per node (specify when mode is multiple)")
    parser.add_argument('--use_lmdb', type=int, choices=[0, 1], default=0, help="Whether datasets are in LMDB format (0: No, 1: Yes)") 
    parser.add_argument('--script_prv', type=str, help='Name of the previous training script')
    parser.add_argument('--config_prv', type=str, default='baseline', help='Name of the previous YAML configuration file')
    parser.add_argument('--use_wandb', type=int, choices=[0, 1], default=0, help="Whether to use Weights & Biases for logging (0: No, 1: Yes)")
